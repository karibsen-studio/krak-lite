...
<template>
  <div class="flex gap-3.5">
    <!-- Imperative API -->
    <button class="relative cursor-pointer overflow-hidden rounded-md border
    ...
    active:inset-shadow-neutral-800" @click="testTrack">
      Track event
    </button>
    ...
    before:from-white/20 before:to-transparent hover:bg-neutral-800
    active:bg-neutral-950 active:shadow-none
    active:inset-shadow-neutral-800" @click="testFlush">
      Flush
    </button>
